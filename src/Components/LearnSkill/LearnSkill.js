  ...
  let skills = [
    {
      ...
      skill: "SuperSkill",
      prerequisite: [{ value: "HTML" }, { value: "CSS" }, { value: "JS" }],
      tags: [
        { value: "HTML" },
        { value: "CSS" },
    ...
    },
    {
      name: "HTML & CSS",
      skill: "SubSkill",
      prerequisite: [{ value: "Working Internet Connection" }],
      tags: [
        { value: "HTML" },
        { value: "CSS" },
        { value: "Machine Learning" },
    ...
    },
    {
      ...
      skill: "SubSkill",
      prerequisite: [{ value: "Python" }, { value: "Ruby" }],
      tags: [
        { value: "HTML" },
        { value: "CSS" },
        { value: "Machine Learning" },
                  ...
                  <Row className="py-4">
                    ...
                    {skill.tags.map((tag, idx) => {
                      return (
                        <>
                          <Col
                            md={tag.value.length >= 10 ? 3 : 2}
                            xl={tag.value.length >= 10 ? 3 : 2}
                            xs={2}
                          >
                            <div className="box-skill-blueD mobile-font">
                              {tag.value}
                            </div>
                          </Col>
                          {/* <Col md={{ span: 2 }} xl={{ span: 1 }} xs={2}>
                            <div className="box-skill-red mobile-font">CSS</div>
                          </Col>
                          <MyDesktop>
            ...
            <div className="card-css">
              <Row className="pt-2">
                <MyDesktop>
                  ...
                  <Col md={1} lg={1} className="translate-css">
                    <div className="skill text-center">SuperSkill</div>
                  </Col>
                  <Col
                    md={{ span: 3, offset: 1 }}
                    lg={{ span: 3, offset: 1 }}
                ...
                <MyMobile>
                  <Col xs={{ span: 7 }} sm={{ span: 7 }}>
                    <span>
                      <div className="card-heading mobile-card">
                        <Link className="linkTo">Web Development</Link>
                      </div>
                    </span>
                  </Col>
                  <Col
              ...
              <Row className="py-4">
                ...
                <Col md={{ span: 2 }} xl={{ span: 1 }} xs={2}>
                  <div className="box-skill-blue mobile-font">HTML</div>
                </Col>
                <Col md={{ span: 2 }} xl={{ span: 1 }} xs={2}>
                  <div className="box-skill-red mobile-font">CSS</div>
                </Col>
                <MyDesktop>
                  <Col md={{ span: 3 }} xl={{ span: 3 }} xs={0}>
                    <div className="box-skill-blueD">Machine Learning</div>
                  </Col>
                </MyDesktop>
                <Col md={2} xs={{ span: 3 }}>
                  <div className="addition mobile-add">+7 more</div>
            ...
            <div className="card-css">
              <Row className="pt-3">
                ...
                <MyMobile>
                  <Col xs={{ span: 7 }}>
                    <span>
                      <div className="card-heading mobile-card">HTML & CSS</div>
                    </span>
                  </Col>
            ...
            <div className="card-css">
              ...
              <Row>
                <Col md={{ span: 10, offset: 1 }}>
                  <div className="sub-txt">
                    Prerequisite:
                    <span className="req-txt">Python | Ruby</span>
                  </div>
                </Col>
              </Row>
              <Row className="py-4">
